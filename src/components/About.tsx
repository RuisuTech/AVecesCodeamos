...
export default function About() {
  return (
    <section className="bg-netflix-dark py-16 sm:py-20 md:py-24">
      <div className="netflix-container max-w-4xl text-center">
        <h2 className="mb-6 text-3xl font-bold sm:text-4xl md:text-5xl">
          Sobre "A Veces Codeamos"
        </h2>
        <p className="mb-6 text-lg leading-relaxed text-netflix-gray-light sm:text-xl">
        ...
        <p className="mb-8 text-lg leading-relaxed text-netflix-gray-light sm:text-xl">
